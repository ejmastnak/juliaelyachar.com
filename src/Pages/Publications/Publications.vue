...
<template>
  <PageWrapper>
    ...
    <h2 id="books" class="text-5xl w-fit border-b pb-5 border-gray-200">Books</h2>
    ...
    <div class="flex flex-col gap-y-10 divide-y divide-gray-200">
      <div v-for="articleGroup in articles" class="">
        <ArticleGroup
          class="pt-10"
