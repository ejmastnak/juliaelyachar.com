...
<template>
  ...
  >
    ...
    <!-- Desktop -->
    <div class="hidden md:flex max-w-6xl w-fit mx-auto gap-x-12 xl:gap-x-16">

      <img :src="juliaImg" class="max-w-sm xl:max-w-md h-80 rounded object-cover object-right" />
